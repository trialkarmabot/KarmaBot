...
THANOS_STRINGS = [
     ...
     "`Tu Chadha Pahad Pr Krke Chutadd Chode, m bola Utr Bhn K Lode`",
     "`Iss Bachkchodi ki Duniya m Tu gya Bhatak, Gaand m chadhai mooli patte gye atak`",
     "`Jitna Sajegi utna Bjegi!`",
]
ABUSEHARD_STRING = [
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("Click [here](https://github.com/Karma-goku/KarmaBot) to open this Cool Userbot Repo created by @KarmaHacx")
